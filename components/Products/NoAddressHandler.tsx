...
const NoAddressForm = ({ setNoAddressForm, noAddressForm, user }: any) => {
  ...
  const [phoneInput, setPhoneInput] = useState(storedAddress.phone);
  ...
  const submitUserShipping = async (e: SyntheticEvent) => {
    e.preventDefault();
    setIsLoading(true);
  ...
  return (
    ...
    >
      ...
      <form
        ...
        onSubmit={(e) => submitUserShipping(e)}
      >
        <Box
          sx={{
            width: "100%",
        ...
        >
          <Button
            ...
            onClick={() => setNoAddressForm(false)}
          >
            Back
          </Button>
          <Button
